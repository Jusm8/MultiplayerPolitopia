...
@onready var msg_timer:            Timer              = $TopBar/MsgTimer
...
func _ready() -> void:
	...
	msg_timer.timeout.connect(func(): label_message.hide())
...
func set_current_player(player_name: String, is_my_turn: bool) -> void:
...
func set_selected_tile(cell: Vector2i, terrain: int) -> void:
	# Orden del enum MapData.Terrain:
	# 0 = SUELO, 1 = BOSQUE, 2 = VILLA, 3 = MONTANIA, 4 = AGUA
	var terrain_name: String
	match terrain:
		MapData.Terrain.SUELO:    terrain_name = "Campo"
		MapData.Terrain.BOSQUE:   terrain_name = "Bosque"
		MapData.Terrain.VILLA:    terrain_name = "Ciudad"
		MapData.Terrain.MONTANIA: terrain_name = "Montaña"
		MapData.Terrain.AGUA:     terrain_name = "Agua"
		_:                        terrain_name = "Desconocido"
